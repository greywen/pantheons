...
type ChatModels$b = QWenMax | QWenPlus | QWenTurbo | QWenLong | QWenOmni | QWenVL | QWenORC | QWenAudio | QWenASR | QWenMath | QWenCoder;
...
type ChatModels$a = 'hunyuan-TurboS' | 'hunyuan-turbo' | 'hunyuan-large' | 'hunyuan-large-longcontext' | 'hunyuan-standard' | 'hunyuan-standard-256K' | 'hunyuan-translation' | 'hunyuan-translation-lite' | 'hunyuan-role' | 'hunyuan-functioncall' | 'hunyuan-code' | 'hunyuan-turbo-vision' | 'hunyuan-vision' | 'hunyuan-embedding';
...
type ChatModels$9 = 'kimi-latest' | 'moonshot-v1-8k' | 'moonshot-v1-32k' | 'moonshot-v1-128k' | 'moonshot-v1-8k-vision-preview' | 'moonshot-v1-32k-vision-preview' | 'moonshot-v1-128k-vision-preview';
...
type ChatModels$8 = SiliconFlowText | SiliconFlowVL;
...
type ChatModels$7 = 'deepseek-chat' | 'deepseek-reasoner';
...
type ChatModels$6 = QianfanText | QianfanVL;
...
type ChatModels$5 = 'gemini-2.0-flash-thinking-exp' | 'gemini-2.0-flash' | 'gemini-2.0-flash-lite' | 'imagen-3' | 'gemini-1.5-flash' | 'gemini-1.5-flash-8b' | 'gemini-1.5-pro';
...
type ChatModels$4 = 'llama3.3:latest' | 'llama3.2:latest' | 'llama3.2-vision:latest' | 'deepseek-r1:latest' | 'qwen2.5:latest' | 'qwen2.5-coder:latest' | 'phi4:latest';
...
type ChatModels$3 = ZhiPuText | ZhiPuVL | ZhiPuAudio | ZhiPuVector;
...
type ChatModels$2 = 'grok-3' | 'grok-2-latest' | 'grok-2-vision-latest';
...
type ChatModels$1 = "yi-lightning" | "yi-large" | "yi-large-fc" | "yi-medium" | "yi-vision" | "yi-vision-solution" | "yi-vision-v2" | "yi-medium-200k" | "yi-spark" | "yi-large-preview";
...
type ChatModels = 'minimax-text-01' | 'abab6.5s-chat' | 'deepseek-r1';
...
export { DashScope, DeepSeek, Gemini, HunYuan, LingYiWanWu, MiniMax, Moonshot, Ollama, OpenAI, Qianfan, SiliconFlow, XAI, ZhiPu };
