...
type ChatModels$a = QWenMax | QWenPlus | QWenTurbo | QWenLong | QWenOmni | QWenVL | QWenORC | QWenAudio | QWenASR | QWenMath | QWenCoder;
...
type ChatModels$9 = 'hunyuan-TurboS' | 'hunyuan-turbo' | 'hunyuan-large' | 'hunyuan-large-longcontext' | 'hunyuan-standard' | 'hunyuan-standard-256K' | 'hunyuan-translation' | 'hunyuan-translation-lite' | 'hunyuan-role' | 'hunyuan-functioncall' | 'hunyuan-code' | 'hunyuan-turbo-vision' | 'hunyuan-vision' | 'hunyuan-embedding';
...
type ChatModels$8 = 'kimi-latest' | 'moonshot-v1-8k' | 'moonshot-v1-32k' | 'moonshot-v1-128k' | 'moonshot-v1-8k-vision-preview' | 'moonshot-v1-32k-vision-preview' | 'moonshot-v1-128k-vision-preview';
...
type ChatModels$7 = SiliconFlowText | SiliconFlowVL;
...
type ChatModels$6 = 'deepseek-chat' | 'deepseek-reasoner';
...
type ChatModels$3 = 'llama3.3:latest' | 'llama3.2:latest' | 'llama3.2-vision:latest' | 'deepseek-r1:latest' | 'qwen2.5:latest' | 'qwen2.5-coder:latest' | 'phi4:latest';
...
type ChatModels$2 = ZhiPuText | ZhiPuVL | ZhiPuAudio | ZhiPuVector;
...
type ChatModels$1 = 'grok-3' | 'grok-2-latest' | 'grok-2-vision-latest';
...
type ChatModels = "yi-lightning" | "yi-large" | "yi-large-fc" | "yi-medium" | "yi-vision" | "yi-vision-solution" | "yi-vision-v2" | "yi-medium-200k" | "yi-spark" | "yi-large-preview";
